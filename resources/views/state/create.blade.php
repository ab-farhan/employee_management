...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><a href="{{ route('state.index') }}">States</a> / Add</h1>
    
</div>
 <!-- DataTales Example -->
 <div class="card shadow mb-4">
    <div class="card-header py-3">
        <h5 class="m-0 mt-2 font-weight-bold text-primary d-inline-block">Add State</h5> <a class="float-right btn btn-primary" href="{{route('state.index')}}"> <i class="fas fa-plus-eye "></i> All Countries</a>
    </div>
    <div class="card-body">
