...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><a href="{{ route('users.index') }}">Countries</a> / Edit</h1>
    
</div>
 <!-- DataTales Example -->
 <div class="card shadow mb-4">
    <div class="card-header py-3">
        <h5 class="m-0 mt-2 font-weight-bold text-primary d-inline-block">Edit Country</h5> <a class="float-right btn btn-primary" href="{{route('country.index')}}"> <i class="fas fa-plus-eye "></i> All Countries</a>
    </div>
    <div class="card-body">
                    ...
                    <form action="{{ route('country.update',$country->id)}}" method="post" >
                        ...
                        <div class="form-group ">
                            <label for="country_code" class="text-dark">Country Code</label>
                                <input id="country_code" type="text" class="form-control @error('country_code') is-invalid @enderror" name="country_code" value="{{ old('country_code',$country->country_code) }}" required autocomplete="country_code" >
    ...
    <div class="card-footer">
        <a id="IdDelete" data-toggle="modal" data-target="#Deletecountry" href="javascript:void()" class="btn btn-danger">Delete Country</a>
    </div>
</div>
