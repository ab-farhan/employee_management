...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><a href="{{ route('department.index') }}">Department</a> / rdit</h1>
    
</div>
 <!-- DataTales Example -->
 <div class="card shadow mb-4">
    <div class="card-header py-3">
        <h5 class="m-0 mt-2 font-weight-bold text-primary d-inline-block">Edit Department</h5> <a class="float-right btn btn-primary" href="{{route('department.index')}}"> <i class="fas fa-plus-eye "></i> All Cities</a>
    </div>
    <div class="card-body">
        ...
        <div class="card-footer">
            <a data-toggle="modal" data-target="#DeleteDep" href="javascript:void()" class="btn btn-danger">Delete Department</a>
        </div> 
</div>

<!-- Modal -->
<div class="modal fade" id="DeleteDep" tabindex="-1" role="dialog" aria-labelledby="mySoftDeleteLabel">
    <div class="modal-dialog" role="document">
        <form method="post" action="{{ route('department.destroy',$department->id) }}">
            ...
            <div class="modal-content primary">
                ...
                <input type="hidden" id="modal_id" name="modal_id" value="{{$department->id}}">
                </div>
