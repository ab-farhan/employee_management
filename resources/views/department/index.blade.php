...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
 ...
 <div class="card shadow mb-4">
    <div class="card-header py-3">
        <h5 class="m-0 mt-2 font-weight-bold text-primary d-inline-block">All Department</h5> <a class="float-right btn btn-primary" href="{{route('department.create')}}"> <i class="fas fa-plus-circle "></i> Add Department</a>
    </div>
    <div class="card-body">
            ...
            <table class="table table-bordered" id="" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$data->id}}</td>
                        <td>{{$data->name}} </td>
                        <td> <a href="{{ route('department.edit', $data->id) }}" class="btn"><i class="fas fa-edit"></i></a> </td>               
                    </tr>
                    @endforeach
                </tbody>
            </table>
