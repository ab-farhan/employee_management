...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"> <router-link :to="{name:'EmployeesIndex'}" class="text-decoration-none"> Employees </router-link> / Add</h1>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <datepicker id="birth_date" name="birth_date" input-class="form-control" required placeholder="Birth Date"  v-model="formData.birth_date"> </datepicker>                             
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <datepicker id="date_hired" name="date_hired" input-class="form-control" required placeholder="Join Date"  v-model="formData.date_hired"> </datepicker>                        
                                </div>
                            </div>
                        </div>
